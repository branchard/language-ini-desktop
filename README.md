# Syntax support for INI files in Atom[![Build Status](https://travis-ci.org/fusion809/language-ini-desktop.svg?branch=master)](https://travis-ci.org/fusion809/language-ini-desktop)
